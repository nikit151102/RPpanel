...
export class ReferenceBookService {
  ...
  getRecords(): Observable<any[]> {
    ...
    return this.http.post<any[]>(`${environment.apiLogisticsUrl}/${this.endpoint}/Filter`, this.queryData, { headers: this.getHeader() });
  }
  ...
  getRecord(id: string): Observable<any> {
    return this.http.get<any>(`${environment.apiLogisticsUrl}/${this.endpoint}/${id}`, { headers: this.getHeader() });
  }

  // Создание новой записи
  newRecord(record: any): Observable<any> {
    return this.http.post<any>(`${environment.apiLogisticsUrl}/${this.endpoint}`, record, { headers: this.getHeader() });
  }

  // Обновление существующей записи
  updateRecord(id: number, record: any): Observable<any> {
    return this.http.put<any>(`${environment.apiLogisticsUrl}/${this.endpoint}/${id}`, record, { headers: this.getHeader() });
  }

  // Удаление записи
  deleteRecord(id: number): Observable<any> {
    return this.http.delete<any>(`${environment.apiLogisticsUrl}/${this.endpoint}/${id}`, { headers: this.getHeader() });
  }

  getPosition() {
    return this.http.post<any>(`${environment.apiLogisticsUrl}/api/Entities/Position/Filter`, { filters: [], sorts: [] }, { headers: this.getHeader() });
  }

  getPermision() {
    return this.http.post<any>(`${environment.apiLogisticsUrl}/api/Entities/Permission/Filter`,
      {
        filters: [{
